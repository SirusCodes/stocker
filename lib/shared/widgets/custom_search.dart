...
class _CustomSearchPage<T> extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState createState() => _CustomSearchPageState<T>();
}

class _CustomSearchPageState<T> extends ConsumerState<_CustomSearchPage<T>> {
        ...
        child: Scaffold(
          appBar: AppBar(
            ...
            title: TextField(
              ...
              onChanged: widget.delegate._onSearchChanged,
